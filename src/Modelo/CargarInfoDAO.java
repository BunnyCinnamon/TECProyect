...
/**
 * Descripción: MYQSL para CargarInfo
 *
 */
@CleanupDone
public class CargarInfoDAO {
    ...
    ////////////////////////////////////////////////////////////////////////////
    private final String SQL_SEARCH_MAX_EXISTENCIA_LIBRO = "SELECT Titulo,Existencias FROM Libro JOIN Ejemplar WHERE IdLibro=Libro AND Existencias=(SELECT MAX(Existencias) FROM Ejemplar) LIMIT 1";
     ...
     * la base de datos.
     *
     * Descripción: Ingresa los datos encontrados de la localización en el Combo
     * box de la vista administrador. Ingresa los datos encontrados del área en
     * el Combo box de la vista administrador. Ingresa los datos encontrados del
    ...
    /**
     * Uso: Busca todos los datos de Autor y Editorial en la base de datos.
     *
     * Descripción: Ingresa los datos encontrados del autor en el List Model de
    ...
    /**
     * Uso: Busca el Libro con más existencias, la Editorial con menos
     * existencias, y el Libro con más préstamos en la base de datos.
     *
     * Descripción: Ingresa los datos encontrados del libro con más existencias
     * en un array list e introduce texto descriptivo. Ingresa los datos
     * encontrados de la editorial con menos existencias en un array list e
    ...
    /**
     * Uso: Busca todos los datos de Localización en la base de datos.
     *
     * Descripción: Ingresa los datos encontrados de la localización en un array
    ...
    /**
     * Uso: Busca todos los datos de Area en la base de datos.
     *
    ...
    /**
     * Uso: Busca todos los datos de Editorial en la base de datos.
     *
     * Descripción: Ingresa los datos encontrados de la editorial en un array
     * list. Ingresa el array list en la tabla, elimina los datos del array list
     * y repite hasta encontrar todos los datos.
     *
     * @param t // Contiene el objeto Tabla de la Vista
    ...
    /**
     * Uso: Busca todos los datos de Prestamos en la base de datos.
     *
    ...
    /**
     * Uso: Busca los datos de Prestamos del el Socio en la base de datos.
     *
     * Descripción: Ingresa los datos encontrados de prestamos en un array list.
     * Ingresa el array list en la tabla, elimina los datos del array list y
     * repite hasta encontrar todos los datos.
