...
/**
 * Descripción: Controlador para Préstamos
 *
 */
@CleanupDone
public class AsignarSocioControlador {
    ...
    /**
     * Uso: Cargar Datos a la vista del Asignar Socio.
     *
     * Descripción: Lee los objetos y los introduce en variables tipo tabla
    ...
    public void LoadData(Object[] U) {
        ...
        model0.addRow(new Object[]{SocioBean.getNombre(), SocioBean.getApellidoP(), SocioBean.getApellidoM(), SocioBean.getEstado(), SocioBean.getUsuario()});
    }

    /**
     * Uso: Aceptar el Prestamo solicitado.
     *
